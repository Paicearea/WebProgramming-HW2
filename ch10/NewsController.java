...
public class NewsController extends HttpServlet {
   ...
   private String putNews(HttpServletRequest request) {
	    // 리디렉션을 통해 JSP 화면으로 이동
	    return "redirect:/news.nhn?action=showNewsPut";
	}
   public String showNewsPut(HttpServletRequest request) {
	    // newsPut.jsp로 포워딩
	    return "ch10/newsPut.jsp";
	}
   
   private String goNews(HttpServletRequest request) {
	    // 리디렉션을 통해 JSP 화면으로 이동
	    return "redirect:/news.nhn?action=showNewsList";
	}
